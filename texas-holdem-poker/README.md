# texas-holdem-poker
A Clojure library designed to implement a real game of texas holdem poker against a dealer.

# usage
This project will allow a user to play texas holdem against a dealer and maintain their chips and totals for whenever they rejoin.
...
Open `src/cljs/texas-holdem-poker/core.cljs`, and change `dom/h1` to
